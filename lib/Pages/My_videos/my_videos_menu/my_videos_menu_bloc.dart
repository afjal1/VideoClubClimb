...
class MyVideosMenuBloc extends Bloc<MyVideosMenuEvent, MyVideosMenuState> {
  ...
  MyVideosMenuBloc({required this.dataRepo})
      : super(MyVideosMenuState(categories: [], videos: [], videosNames: [])) {
  ...
  _getCategoriesMyVideosMenu(GetCategoriesMyVideosMenuEvent event,
      Emitter<MyVideosMenuState> emit) async {
    emit(
        MyVideoMenuFormSubmitting(categories: [], videos: [], videosNames: []));
  ...
  FutureOr<void> _getVideosInACategoryMyVideosMenu(
      CategoryClickedMyVideosMenuEvent event, Emitter<MyVideosMenuState> emit) {
