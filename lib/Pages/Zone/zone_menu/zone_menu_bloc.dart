...
class ZoneMenuBloc extends Bloc<ZoneMenuEvent, ZoneMenuState> {
  ...
  ZoneMenuBloc({required this.dataRepo})
      : super(ZoneMenuState(categories: [], videos: [], videosNames: [])) {
  ...
  _deleteEverything(DeleteEverything event, Emitter<ZoneMenuState> emit) async {
  ...
  _getCategoriesZoneMenu(
      GetCategoriesZoneMenuEvent event, Emitter<ZoneMenuState> emit) async {
    // emit(state.copyWith(formSubmissionState: FormSubmitting()));

    emit(ZoneMenuFormSubmitting(categories: [], videos: [], videosNames: []));
  ...
  FutureOr<void> _getVideosInACategoryZoneMenu(
      CategoryClickedZoneMenuEvent event, Emitter<ZoneMenuState> emit) {
  ...
  FutureOr<void> _refreshListsZoneMenu(
      RefreshListsZoneMenuEvent event, Emitter<ZoneMenuState> emit) async {
  ...
  FutureOr<void> _searchVideosZoneMenu(
      SearchEventZoneMenu event, Emitter<ZoneMenuState> emit) {
