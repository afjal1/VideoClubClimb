...
class VideosCubit extends Cubit<VideoState> {
  ...
  showZoneVideos(String category, int currentCategory) => emit(
      ViewingZoneVideos(category: category, currentCategory: currentCategory));
  ...
  showMyVideos(String category, int currentCategory, String name) =>
      emit(ViewingMyVideos(
          category: category, currentCategory: currentCategory, name: name));
  ...
  watchVideo(
          ...
          required String url}) =>
      emit(WatchingVideo(
          category: category, name: name, UIName: UIName, url: url));
}
